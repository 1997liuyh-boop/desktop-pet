...
class GraphCore {
  ...
  async preloadCommon() {
    const common = [
      ...
      ['raise', 'normal', 'b_loop'],
      ['raise', 'happy', 'b_loop'],
      ['raise', 'poorCondition', 'b_loop'],
      ['raise', 'ill', 'b_loop'],
      ['eat', 'normal', 'a_start'],
      ['eat', 'normal', 'b_loop'],
      ['eat', 'normal', 'c_end'],
      ['drink', 'normal', 'a_start'],
      ['drink', 'normal', 'b_loop'],
      ['drink', 'normal', 'c_end'],
      ['gift', 'normal', 'a_start'],
      ['gift', 'normal', 'b_loop'],
      ['gift', 'normal', 'c_end'],
      ['calligraphy', 'normal', 'a_start'],
      ['calligraphy', 'normal', 'b_loop'],
      ['calligraphy', 'normal', 'c_end'],
      ['study', 'normal', 'a_start'],
      ['study', 'normal', 'b_loop'],
      ['study', 'normal', 'c_end'],
      ['studypaint', 'normal', 'a_start'],
      ['studypaint', 'normal', 'b_loop'],
      ['studypaint', 'normal', 'c_end'],
      ['playone', 'normal', 'a_start'],
      ['playone', 'normal', 'b_loop'],
      ['playone', 'normal', 'c_end'],
      ['work', 'normal', 'a_start'],
      ['work', 'normal', 'b_loop'],
      ['work', 'normal', 'c_end'],
      ['workone', 'normal', 'a_start'],
      ['workone', 'normal', 'b_loop'],
      ['workone', 'normal', 'c_end'],
      ['worktwo', 'normal', 'a_start'],
      ['worktwo', 'normal', 'b_loop'],
      ['worktwo', 'normal', 'c_end'],
      ['workclean', 'normal', 'a_start'],
      ['workclean', 'normal', 'b_loop'],
      ['workclean', 'normal', 'c_end'],
      ['say', 'normal', 'a_start'],
      ['say', 'normal', 'b_loop'],
      ['say', 'normal', 'c_end'],
